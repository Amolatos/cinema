    ...
    <nav class="bg-gray-800" x-data="{ open: false }">
            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center">
                        <span class="text-white font-bold text-xl">Cinema</span>
                    </a>
                </div>
                    ...
                    @else
                        ...
                        <div class="relative" x-data="{ open: false }" @click.away="open = false">
                            <button @click="open = !open" class="nav-link flex items-center space-x-1">
                                ...
                                <span class="ml-1 px-2 py-1 text-xs rounded-full {{ Auth::user()->isAdmin() ? 'bg-red-600' : 'bg-green-600' }}">
                ...
                <div class="md:hidden flex items-center">
                    <button @click="open = !open" 
                            class="mobile-menu-button p-2 rounded-md text-gray-400 hover:text-white focus:outline-none"
        ...
        <div :class="{'block': open, 'hidden': !open}" class="md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                @else
                    <a href="{{ route('dashboard') }}" class="nav-link block">Dashboard</a>
                    <div class="px-3 py-2">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p class="text-sm">Experience the magic of cinema with the best movie experience in town.</p>
                </div>
                <div>
                    <h3 class="text-lg font-semibold mb-4">Quick Links</h3>
                    <ul class="space-y-2">
                        <li><a href="#" class="text-sm hover:text-white transition-colors duration-200">Movies</a></li>
                        <li><a href="#" class="text-sm hover:text-white transition-colors duration-200">Showtimes</a></li>
            ...
            <div class="mt-8 border-t border-gray-700 pt-8 text-center">
                <p class="text-sm">&copy; {{ date('Y') }} Cinema Experience. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
